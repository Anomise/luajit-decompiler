...
static constexpr uint8_t BC_HEADER_MODIFIED[] = { '\x1B', 'K', 'L' }; // Modified header for Elsword (1B 4B 4C)
static constexpr uint8_t BC_VERSION_1 = 1;
static constexpr uint8_t BC_VERSION_2 = 2;
static constexpr uint8_t BC_VERSION_MODIFIED = 0x81; // Modified bytecode version for Elsword
